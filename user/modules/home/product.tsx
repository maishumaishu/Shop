...
//     let shoppingService = page.createService(ShoppingService);
...
//     shoppingService.product(id).then((product) => {
//         let productPage = ReactDOM.render(
//             <ProductPage product={product} shop={shoppingService} shoppingCart={shoppingCart} />,
//             page.element
//         )
//     });
