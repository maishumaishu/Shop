...
(function () {
    ...
    var Upload = {
        ...
        uploadComplete: function (r) {
            var me = this;
            try {
                var json = typeof r == 'object' ? r : eval('(' + r + ')');
        ...
        imageFileToBase64(file): Promise<string> {
        ...
        submit: function (callback) {
            ...
            var me = this,
                ...
                input = input[0] as any as JQuery;
            ...
            $(me.dialog).delegate(".edui-image-file", "change", function (e) {
                ...
                //=====================================================================
                // 说明：将原来的 iframe 提交数据，改为 POST 提交
                var file = (e.target as HTMLInputElement).files[0];
                var originalName = file.name;
                me.imageFileToBase64(file).then(function (data) {
                ...
                //     var r = '{"originalName": "Chrysanthemum.jpg","name": "637dcdb7-854f-4c82-ad74-4e35a6ccd8e9.jpg","url": "upload/2017-09-04/637dcdb7-854f-4c82-ad74-4e35a6ccd8e9.jpg","size": "879394","state": "SUCCESS","type": ".jpg"}';
                //     if (r == '') return;
                //     me.uploadComplete(r);
                //     $(this).unbind('load');
                //     $(this).remove();
                    ...
                    $.each(fileList, function (i, f) {
                        if (/^image/.test(f.type)) {
                            ...
                            xhr.addEventListener('load', function (e) {
                                var r = (e.target as any).response, json;
                                me.uploadComplete(r);
    ...
    UM.registerWidget('image', {
        ...
        initContent: function (editor, $dialog) {
            ...
            if (lang) {
                var html = ($ as any).parseTmpl(this.tpl, opt);
            }
        ...
        initEvent: function (editor, $w) {
            $tab = ($ as any).eduitab({ selector: ".edui-image-wrapper" })
