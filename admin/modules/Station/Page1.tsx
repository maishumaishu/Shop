...
export default async function (page: chitu.Page) {
    ...
    class Page1 extends React.Component<{ pageData: PageData }, State>{
        private designer: MobilePageDesigner;
        constructor(props) {
            super(props);
            // this.state = { componentInstances: [] };
            // if (pageId) {
            //     station.pageData(pageId).then(pageData => {
            //         this.state.componentInstances = pageData.controls;
            //         this.setState(this.state);
            //     });
            // }
            // else {
            //     station.pageDataByTemplate(templateId).then(pageData => {
            //         this.state.componentInstances = pageData.controls;
            //         this.setState(this.state);
            //     });
            // }
    ...
    ReactDOM.render(<Page1 pageData={pageData} />, page.element);
}
