$(function () {
    ...
    //});
    ////======================================================================================
    //var d = $('#LocalUrl').data('ace_file_input')
    ...
    //        return;
    //    }
    //    var result = _show_file_list.call(d, $files);
    ...
    ////======================================================================================
    //// 说明：重写reset_input_field方法是为了解决在IE下，无法把已经选择的文件给移除。
    //d.reset_input_field = function () {
    //    //http://stackoverflow.com/questions/1043957/clearing-input-type-file-using-jquery/13351234#13351234
    //    this.$element.wrap('<form>').closest('form').get(0).reset();
    //    this.$element.unwrap();
    //    this.$element.replaceWith(this.$element.clone(true));
    //}
    ////========================================================

    //var url = $('#LocalUrl').attr('data-url');
    //if (url != '' && url != null) {
    ...
    $('#ImageUpload').fileupload({
        url: '/Common/UploadImage?dir=Shopping',
        dataType: 'json'
    }).on('fileuploaddone', function (e, data) {
        $('#PicUrl').val(Site.imageServerUrl + data.result.path);
