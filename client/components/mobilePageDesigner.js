...
define(["require", "exports", "components/componentDefines", "components/virtualMobile", "components/mobilePage", "components/editor", "prop-types", "components/designTimeUserApplication", "ui", "user/site", "dilu", "jquery-ui"], function (require, exports, componentDefines_1, virtualMobile_1, mobilePage_1, editor_1, prop_types_1, designTimeUserApplication_1, ui, site_1, dilu_1) {
    "use strict";
    ...
    class MobilePageDesigner extends React.Component {
        ...
        preview() {
            ...
            let url = site_1.app.createUrl(site_1.siteMap.nodes.page, { pageId: pageData.id });
            open(url, '_blank');
        }
